...
\begin{frame}{Probleme \& Lösungsansätze}
  \begin{figure}
    \begin{overprint}
      \onslide<1-2>
        \centering
        \includegraphics[width=.5\linewidth]{figures/fg-memory-galerkin.pdf}
        \caption{Speicherbedarf einer Galerkin-Diskretisierung.}
      \onslide<3>
        \centering
        \includegraphics[width=.5\linewidth]{figures/fg-memory-galerkin-h2.pdf}
        \caption{Speicherbedarf einer Galerkin-Diskretisierung und deren
