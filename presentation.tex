...
\begin{frame}{Randwertprobleme}
  \begin{columns}
    \column{0.675\linewidth}
      \begin{itemize}
        \visible<1->{\item Werden verwendet in der
                     \begin{itemize}
                       \item Elektrostatik
                       \item Wärmeleitung
                       \item Akustik
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \visible<3->{\(G|_{\tau \times \sigma} \approx
                           ...
                           W_{\sigma}^{*}\)}
    \end{itemize}
    \item \visible<4->{Nicht-Blätter: Greens zweite Identität auf die von den Söhnen ausgewählten Basisfunktionen und ACA}
  \end{itemize}
