...
\begin{frame}{Problem \& Lösungsansätze}
  ...
  \begin{table}[h]
    \begin{tabular}{rrr} \toprule
                & \multicolumn{2}{c}{Performanz in ms\footnotemark[1]} \\ \cmidrule{2-3}
      Dimension & \(\mathcal{H}^2\)-MVM &
      \begin{tabular}{@{}c@{}}\(\mathcal{H}^2\)-MVM + \\ Blockmatrizen \\ on-the-fly\end{tabular} \\ \midrule
        16384 &  140 &   23390 \\
        32768 &  300 &   50740 \\
        65536 &  660 &  100160 \\
       131072 & 1190 &  205210 \\ \bottomrule
    \end{tabular}
  \end{table}
  \normalsize
  \begin{itemize}
...
\begin{frame}{2.-4. Phase (Nahfeld)}
  ...
  \end{itemize}
  \footnotesize
  \footnotetext[1]{Quelle: On the efficient computation of singular and nearly singular surface integrals arising in 3D-Galerkin BEM}
  \normalsize
\end{frame}
...
\begin{frame}{3. Phase}
  ...
  \begin{table}
    \begin{tabular}{rrrrrr} \toprule
      ...
      & \begin{tabular}{@{}c@{}}GeForce \\ GTX 680\end{tabular}
      & \begin{tabular}{@{}c@{}}GeForce \\ GTX 760\end{tabular} \\ \cmidrule{1-6}
       16384 &  420.000 &  2453.863 &  63.717 &  89.152 &  83.960 \\
       32768 &  850.000 &  4963.603 & 132.433 & 197.693 & 177.870 \\
       65536 & 1680.000 &  9840.110 & 255.715 & 428.641 & 354.457 \\
      131072 & 3380.000 & 19829.370 & 508.279 & 734.910 & --- \\
      \bottomrule
    \end{tabular}
  \end{table}
  \normalsize
...
\begin{frame}{4. Phase}
  ...
  \begin{table}
    \begin{tabular}{rrrrrr} \toprule
      ...
      & \begin{tabular}{@{}c@{}}GeForce \\ GTX 680\end{tabular}
      & \begin{tabular}{@{}c@{}}GeForce \\ GTX 760\end{tabular} \\ \cmidrule{1-6}
       16384 & 1160.000 &  6007.246 &  32.705 &  50.510 &  46.254 \\
       32768 & 2360.000 & 12146.984 &  70.949 & 114.736 & 103.447 \\
       65536 & 4650.000 & 24019.114 & 137.341 & 247.243 & 200.640 \\
      131072 & 9440.000 & 48587.012 & 261.457 & 410.919 & --- \\
      \bottomrule
    \end{tabular}
  \end{table}
  \normalsize
...
\begin{frame}{1.-4.Phase im Vergleich}
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/fg-performance-feval-1-4.pdf}
    \caption{Performanz der einzelnen Phasen im Vergleich auf einer Tesla
             K20xm.}
  \end{figure}
\end{frame}
...
\begin{frame}{Optimierung: Lokalität von Speicher}
  \begin{algorithm}[H]
    \begin{algorithmic}[1]
      \normalsize
      {
      \Function{fastaddeval\_1\_phase}{}
      \For{i = 0; i < rows; ++i}
       \State{// Hole Informationen über Zeile i.}
        \For{j = 0; j < cols; ++j}
          \State{// Hole Informationen über Spalte j.}
          \For{q = 0; q < nq; ++q}
            \State{// Führe Quadratur bzgl. i, j und q-ten Quadraturpunkt}
            \State{// und -gewicht durch.}
          \EndFor{}
        \EndFor{}
      \EndFor{}
      \EndFunction{}
  ...
  \begin{table}
    \begin{tabular}{rrr} \toprule
      ...
      & Globaler Speicher & Lokaler Speicher \\ \cmidrule{1-3}
       16384 &  367.612 & 305.763  \\ %324 bytes
...
\begin{frame}{Zusammenfassung}
  ...
  \begin{table}
    \begin{tabular}{rrrr} \toprule
                & \multicolumn{3}{c}{Performanz in ms} \\ \cmidrule{2-4}
      Dimension & \(\mathcal{H}^2\)-MVM
                & \begin{tabular}{@{}c@{}}
                    \(\mathcal{H}^2\)-MVM + \\
                    Blockmatrizen \\
          ...
          16384 &  140 &   23390 &  470 \\
          32768 &  300 &   50740 &  970 \\
          65536 &  660 &  100160 & 1510 \\
         131072 & 1190 &  205210 & 2990 \\ \bottomrule
      \end{tabular}
    \end{table}
  \normalsize
  \begin{itemize}
    \item Wir können den Speicherbedarf einer \(\mathcal{H}^2\)-Matrix um
          75-90\% reduzieren
    \item Die benötigte Rechenzeit kann auf GPUs um einen Faktor TODO
          reduziert werden verglichen mit einer CPU-Implementierung
    \item Kann mit einer reinen, BLAS-optimierten und OpenMP-parallelisierten
          \(\mathcal{H}^2\)-Matrix-Vektor-Multiplikation (fast) mithalten.
  \end{itemize}
\end{frame}
